...
public class CreateTestRequest
{
    ...
    // Целеви класове (multi-select). Ако е празен — тестът е отворен с линка.
    // Ако има класове — само ученици от тези класове могат да решават
    // (валидират се по име от students.json).
